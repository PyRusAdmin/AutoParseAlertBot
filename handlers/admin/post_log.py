...
async def log(message: Message, state: FSMContext):
    ...
    - Команда доступна всем пользователям — в продакшен‑среде это может представлять угрозу безопасности.
    ...
    :raises:
        ...
        - отсутствии файла 'logs/log.log';
        - ошибках отправки документа через Telegram Bot API.
