...
LOCALES = {
    "ru": {
        ...
        "welcome_message_template": (
            ...
            "📱 Подключённых аккаунтов: {count}\n"
            "📤 Подключённых технических групп (для пересылки): {group_count}\n"
            "🔍 Отслеживаемых ключевых слов: {keywords_count}\n"
            "Отслеживаемых групп / каналов: {get_groups}\n\n"
            
            "💡 Совет: для получения обновлённого функционала рекомендуется перезапускать бота через /start"
        ),
